<template>
  <q-card class="card rounded column items-center justify-center">
    <q-btn
      ...
      @click="handleClick"
    >
      <q-card-section class="VkIdWebSdk__button_container">
        <q-card-section class="VkIdWebSdk__button_icon">
          <svg
            width="28"
            height="28"
            viewBox="0 0 28 28"
        ...
        <q-card-section class="VkIdWebSdk__button_text">
          Войти через VK ID
        </q-card-section>
      </q-card-section>
    </q-btn>
...
const REDIRECT_URL = 'http://localhost:9000/#/PsyNetVK/login/callback';
// const REDIRECT_URL = 'https://dhsuioa.github.io/PsyNetVK/#/login/callback';
